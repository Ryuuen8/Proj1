...
class ClosEye:
    def __init__(self, root, shared_data):
        ...
        self.ce_timer = ctk.CTkLabel(self.ce_frame, text="00:00:20", fg_color="#e6c9f5", text_color="#000000", font=("Comic Sans MS", 20, "bold"))
...
class LookAway:
    def __init__(self,root, shared_data):
        ...
        self.la_timer = ctk.CTkLabel(self.la_frame, text="00:00:20", fg_color="#e6c9f5", text_color="#000000", font=("Comic Sans MS", 20, "bold"))
...
class Recommendation:
    def __init__(self, root, shared_data):
        ...
        self.r_timer = ctk.CTkLabel(self.r_frame, text="04:20", fg_color="#e6c9f5", text_color="#000000", font=("Comic Sans MS", 20, "bold"))
...
class Option1:
    def __init__(self, root, shared_data):
        ...
        self.o1_yes = ctk.CTkButton(self.o1_frame, text="Yes", fg_color="#e6c9f5", text_color="#000000", font=("Comic Sans MS", 10, "bold"),width=50, height=50, 
                                   border_width=2, border_color="#000000", command=self.yes_button, hover_color="#FF0000")
        self.o1_yes.place(rely=0.55, relx=0.8, anchor="center")
        
        self.no_label = ctk.CTkLabel(self.o1_frame, text="I don't want to take \ncare of my eyes", text_color="#000000", font=("Comic Sans MS", 10, "bold"))
        self.no_label.place(rely=0.73, relx=0.8, anchor="center")
        
        self.o1_no = ctk.CTkButton(self.o1_frame, text="No", fg_color="#e6c9f5", text_color="#000000", font=("Comic Sans MS", 25, "bold"),width=180, height=100, 
                                  border_width=2, border_color="#000000", command=self.no_button)
        self.o1_no.place(rely=0.55, relx=0.3, anchor="center")
        
        self.yes_label = ctk.CTkLabel(self.o1_frame, text="I changed my mind. \nLet's take care of my eyes", text_color="#000000", font=("Comic Sans MS", 12, "bold"))
...
class FOption:
    def __init__(self,root, shared_data):
        ...
        self.fo_yes = ctk.CTkButton(self.fo_frame, text="Yes", fg_color="#e6c9f5", text_color="#000000", font=("Comic Sans MS", 10, "bold"),width=50, height=50, 
                                   border_width=2, border_color="#000000", command=self.yes_button, hover_color="#FF0000")  
        self.fo_yes.place(rely=0.55, relx=0.8, anchor="center")
        
        self.fo_no = ctk.CTkButton(self.fo_frame, text="No", fg_color="#e6c9f5", text_color="#000000",font=("Comic Sans MS", 25, "bold"),width=180, height=100, 
                                  border_width=2, border_color="#000000", command=self.no_button)
...
class Ringtone:
    def __init__(self, root, shared_data):
        ...
        self.paragraph_tips = [
            ...
            "Tip: You Can Select a Ringtone For Your \nTimer by clicking the [Select] Button",
            "Tip: You Can Click The Shuffle Icon On The \nLeft If You Want A Random Ringtone\n[If you added ringtones]"
        ]
        ...
        self.question_label = ctk.CTkButton(self.root, text="?", font=("Comic Sans MS", 30, "bold"), corner_radius=100, height=40, width=40, fg_color="#000000", command=self.question_button)
        ...
        self.tip_label = ctk.CTkLabel(self.label_frame, text="")
    ...
    def question_button(self):
    # Set a random tip as the label text for the slider
